...
const Mobiles = () => {
    ...
    useEffect(()=>{
        const pageTimeout = setTimeout(()=>{
            axios.get(process.env.REACT_APP_URL_API_DATA+'/model/mobiles/no-of-pages?size='+sizeOfPages+'&search='+search).then((res)=>{
    ...
    useEffect(()=>{
        const dataTimeout = setTimeout(()=>{
            if(!noRecord){
                axios.post(process.env.REACT_APP_URL_API_DATA+'/model/mobiles?page='+currentPage+'&size='+sizeOfPages,{search:search}).then((res)=>{
                    setData(res.data)
                })
            }
        },DELAY_TIME)
