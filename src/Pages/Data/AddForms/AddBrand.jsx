...
const AddBrand = () => {
    ...
    const submitForm =(e)=>{
        ...
        if(checked){
            if(label.trim().length > 0){
                setSubmiting(true);
                axios.post(process.env.REACT_APP_URL_API_DATA+'/brand/add',
                {
                    brand_name:label,
                    is_mobile:mobile,
                    is_tab:tab,
    ...
    return ( <>
        ...
        <div className='d-flex justify-content-center mx-4 mb-2'>
             <h2 className='text-secondary'>Add Brand</h2>
        </div> 
        <Form  noValidate validated={validated} onSubmit={submitForm}>
            <Form.Group className='mb-3' controlId='label'>
                ...
                {
                    labelError &&
                    <span style={{color:'red'}}>*Brand Name Must be less than 60 characters.</span>
                }
            </Form.Group>
            <Row>
