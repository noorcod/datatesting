...
const EditDesktopComputers = () => {
    ...
    useEffect(()=>{
        axios.post(process.env.REACT_APP_URL_API_DATA+'/model/desktop-computers/'+id).then((res)=>{
                ...
                setDesktopType({value:res.data[0].dt_id,label:res.data[0].desktop_type})
    ...
    return ( <>
        ...
        <div className='d-flex justify-content-center mx-4 mb-2'>
             <h2 className='text-secondary'>Edit Desktop Computers</h2>
        </div>
...
export default EditDesktopComputers;