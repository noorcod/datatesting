...
const AddTabs = () => {
    ...
    return ( <>
        ...
        <div className='d-flex justify-content-center mx-4 mb-2'>
             <h2 className='text-secondary'>Add Tabs</h2>
        </div>
            ...
            <Row>
                ...
                <Form.Group as={Col} lg='4' md='6' sm='12' className='mb-3' controlId='title' >
                    ...
                    <AsyncSelect 
                        ...
                        loadOptions={()=>{
                            return new Promise((resolve,reject)=>{
                                axios.post(process.env.REACT_APP_URL_API_DATA+`/color/get`,{is_tab:true})
                                .then(data=>{        
                ...
                <Form.Group as={Col} lg='4' md='6' sm='12' className='mb-3' controlId='model_name' >
                    ...
                    <AsyncSelect 
                        ...
                        loadOptions={()=>{
                            return new Promise((resolve,reject)=>{
                                axios.post(process.env.REACT_APP_URL_API_DATA+`/mobile-storage/get`,{is_tab:true})
                                .then(data=>{              
                ...
                <Form.Group as={Col} lg='4' md='6' sm='12' className='mb-3' controlId='title' >
                    ...
                    <AsyncSelect 
                        ...
                        loadOptions={()=>{
                            return new Promise((resolve,reject)=>{
                                axios.post(process.env.REACT_APP_URL_API_DATA+`/ram/get`,{is_tab:true})
                                .then(data=>{        
                ...
                <Form.Group as={Col} lg='4' md='6' sm='12' className='mb-3' controlId='title' >
                    ...
                    <AsyncSelect 
                        ...
                        loadOptions={()=>{
                            return new Promise((resolve,reject)=>{
                                axios.post(process.env.REACT_APP_URL_API_DATA+`/processor/get`,{is_tab:true})
                                .then(data=>{        
